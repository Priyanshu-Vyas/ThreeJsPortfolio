...
const Developer = ({ animationName = "warrioridle", ...props }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF("/models/human/developer.glb");
  const { animations: warrioridleAnimation } = useFBX(
    "/models/animations/warrioridle.fbx"
  );
  ...
  warrioridleAnimation[0].name = "warrioridle";
